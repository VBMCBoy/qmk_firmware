...
[_GAME] = LAYOUT( \
  ...
  KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B, _______,     _______, XXXXXXX,   KC_P1,    KC_P2,     KC_P3,    KC_EQL,  KC_RSFT, \
...
[_SYMB] = LAYOUT( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,                       KC_R,  KC_E,  KC_PSCR, KC_SCRL, KC_PAUS, KC_F12, \
