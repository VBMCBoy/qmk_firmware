 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LCTR | LGUI | SYMB | LALT | /Enter  /       \Space \  | GAME | RCTR | MENU | RGUI |   Menu works as the compose key
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,     KC_V,    KC_B, KC_OMNU,   KC_OSCT,  KC_N,       KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LCTRL,KC_LGUI,TO(_SYMB),  KC_LALT, KC_ENT,      KC_SPC, TO(_GAME),  KC_RCTRL, KC_APP, KC_RGUI \
),
/* GAME
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | TRNS |   1  |   2  |   3  |   4  |   5  |                    |      |      |   /  |   *  |   -  |      |
