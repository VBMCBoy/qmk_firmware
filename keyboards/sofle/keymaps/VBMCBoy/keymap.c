...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSPO,  KC_Z,   KC_X,    KC_C,     KC_V,    KC_B, KC_OMNU,   KC_OSCT,  KC_N,       KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSPC, \
                 KC_LCTRL,TO(_SYMB), KC_LALT,  KC_LGUI, KC_ENT,      KC_SPC, KC_APP,  KC_ALGR, TO(_GAME), KC_RGUI \
),
/* GAME
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | TRNS |   1  |   2  |   3  |   4  |   5  |                    |      |      |   /  |   *  |   -  |      |
